...
const routes = [
  ...
  { path: '/map/fullscreen', name: 'map-fullscreen', component: () => import('../views/MapFullscreenView.vue'), meta: { auth: true, noLayout: true } },
  { path: '/map/wc', name: 'map-wc', component: () => import('../views/MapWcView.vue'), meta: { auth: true, noLayout: true } },
  ...
  { path: '/saved', name: 'saved', component: () => import('../views/BookmarksView.vue'), meta: { auth: true, noGuest: true } },
  { path: '/profile', name: 'profile', component: () => import('../views/ProfileView.vue'), meta: { auth: true, noGuest: true } },
